...
export const MESSAGES = {
  en: {
    ...
    'topbar.sources.title': 'Upload sources',
    ...
    'tree.section.wiki': 'Wiki',
    'tree.section.rawSources': 'Raw Sources',
    'tree.section.rawSources.empty': 'No raw sources yet — upload some',
    'tree.section.rawSources.open': 'Open sources panel',
    'tree.rawCat.articles': 'Articles',
    'tree.rawCat.meetingNotes': 'Meeting Notes',
    'tree.rawCat.archive': 'Archive',
    'tree.rawCat.moveTo': 'Move to folder',
    'tree.rawCat.topLevel': 'Top level (no folder)',
    'tree.rawCat.newFolder': 'New folder',
    'tree.rawCat.newPrompt': 'New folder name:',
    'tree.rawCat.empty': 'Empty',
    ...
    'menu.page.shareLink': 'Share private link',
    ...
    'page.draftBanner': 'A reviewer requested changes — your draft content is preserved.',
    'page.delete.network': 'network error — the request never reached the server (it may be restarting after a deploy); please retry shortly.',
    'page.draftBanner.resume': 'Resume editing draft',
    ...
    'history.restoredQueued.alert': 'Restore submitted to the review queue — the version takes effect only after it is approved there.',
    'page.flags.resolve': 'Mark handled',
    ...
    'mcp.hide': 'Hide',
    'mcp.reveal': 'Show',
    'mcp.configCopy': 'Copy config',
    'mcp.tokenHidden': 'Hidden — click the eye to show again.',
    'mcp.showConfig': 'Show config',
    'mcp.templateNote': 'Paste the token you saved at creation into the Bearer field — the original cannot be re-shown.',
    ...
    'propose.field.folder': 'Folder',
    'propose.field.name': 'Name',
    'propose.field.name.placeholder': 'my-new-note',
    'propose.done.submitted.new': 'Your new source was submitted.',
    'propose.done.submitted.edit': 'Your edit was submitted.',
    'propose.done.status': 'Status:',
    'propose.done.badge.accepted': 'Published',
    'propose.done.badge.proposed': 'Pending review',
    'propose.done.hint.accepted': ' — open pages autopublish; your change is live.',
    'propose.done.hint.proposed': ' — an editor or admin will review it; you\'ll be notified.',
    'propose.done.close': 'Close',
    'sources.err.urlUpstream': 'The target site refused the automated fetch. Save the page as PDF/Markdown and use "Upload file" instead.',
    'menu.file.copy.suffix': '(copy)',
    'menu.file.copy.queued': 'Copy submitted for review — you\'ll be notified when it\'s published.',
    'menu.file.copy.exists': 'A copy already exists — please try again.',
    'menu.file.copy.failed': 'Copy failed:',
    'propose.field.title': 'Title',
    'propose.field.body': 'Body',
    'propose.missing.prefix': 'Fill in required:',
    ...
    'propose.err.exists': 'A page already exists at "{path}". Pick a different name, or open the existing one.',
    'propose.err.exists.open': 'Open existing page',
    'propose.err.generic': 'Could not submit: {msg}',
  ...
  zh: {
    ...
    'tree.graph2d': '图谱（2D）',
    'tree.graph3d': '图谱（3D）',
    'tree.section.wiki': '知识库',
    'tree.section.rawSources': '原始资料',
    'tree.section.rawSources.empty': '暂无原始资料 — 点击上传',
    'tree.section.rawSources.open': '打开资料面板',
    'tree.rawCat.articles': '文章',
    'tree.rawCat.meetingNotes': '会议记录',
    'tree.rawCat.archive': '归档',
    'tree.rawCat.moveTo': '移动到文件夹',
    'tree.rawCat.topLevel': '顶层（无文件夹）',
    'tree.rawCat.newFolder': '新建文件夹',
    'tree.rawCat.newPrompt': '新文件夹名称：',
    'tree.rawCat.empty': '空',
    ...
    'menu.file.suggest': '编辑',
    'menu.file.suggest.disabled': '只读用户无法编辑',
    'menu.file.copy': '创建副本',
    ...
    'menu.page.addProp.hint': '请暂用"编辑"中的 tags 字段',
    ...
    'page.draftBanner': '审阅人请求了修改——你填写的草稿内容还在。',
    'page.delete.network': '网络错误——请求没有到达服务器（后端可能正在重启部署），请稍后重试。',
    'page.draftBanner.resume': '继续编辑草稿',
    'history.title': '版本历史',
    'history.empty': '暂无修订。',
    'history.current': '当前',
    ...
    'history.restoredQueued.alert': '恢复已提交至审核队列——需在审核队列中审批通过后，该版本才会生效。',
    'page.flags.resolve': '标记为已处理',
    ...
    'sources.ingestTitle': '触发提取 — 智能体阅读资料并提出编辑建议，需经你审核后才会生成草稿。',
    'sources.ingest': '提取',
    'sources.history': '查看提取历史',
    'sources.download': '下载',
    ...
    'sources.retryIngestTitle': '重试提取——上次运行失败；这将重新启动计划阶段。',
    'sources.retryIngest': '重试提取',
    ...
    'schema.adminOnly': '仅管理员可见 — 此为提取智能体所遵循的系统提示词。',
    'schema.close': '关闭',
    'schema.readOnly': '只读',
    'schema.view.edit': '编辑',
    ...
    'mcp.reveal': '显示',
    'mcp.configCopy': '复制配置',
    'mcp.tokenHidden': '已隐藏——点击眼睛重新显示。',
    'mcp.showConfig': '查看配置',
    'mcp.templateNote': '把创建时保存的 token 填入 Bearer 字段——原始 token 无法再次显示。',
    ...
    'propose.field.folder': '文件夹',
    'propose.field.name': '名称',
    'propose.field.name.placeholder': '笔记名称',
    'propose.done.submitted.new': '你的新资料已提交。',
    'propose.done.submitted.edit': '你的修改已提交。',
    'propose.done.status': '状态：',
    'propose.done.badge.accepted': '已发布',
    'propose.done.badge.proposed': '待审核',
    'propose.done.hint.accepted': ' — 开放页面自动发布，你的更改已生效。',
    'propose.done.hint.proposed': ' — 编辑或管理员审核后会通知你。',
    'propose.done.close': '关闭',
    'sources.err.urlUpstream': '目标网站拒绝了自动抓取。请将页面另存为 PDF/Markdown 后，改用「上传文件」导入。',
    'menu.file.copy.suffix': '（副本）',
    'menu.file.copy.queued': '副本已提交审核，发布后会通知你。',
    'menu.file.copy.exists': '副本已存在，请重试。',
    'menu.file.copy.failed': '创建副本失败：',
    'propose.field.title': '标题',
    'propose.field.body': '正文',
    'propose.missing.prefix': '请填写必填项：',
    ...
    'propose.err.exists': '路径 “{path}” 下已存在同名资料。请换一个名称，或直接打开已有资料。',
    'propose.err.exists.open': '打开已有资料',
    'propose.err.generic': '提交失败：{msg}',
    ...
    'review.feedback.notes.placeholder': '说明（会反馈给后续提取智能体）',
    ...
    'manual.sources.body':
      '上传原始输入文档（PDF、Markdown、图片）。每份资料都可以交给 AI 智能体进行提取，智能体会提出结构化编辑，把资料合并进维基。所有编辑仍需走正常审核流程。',
    'manual.playbook.title': '智能体手册',
    'manual.playbook.body':
      '提取智能体在合并原始资料时所遵循的系统提示词。管理员可以编辑它来改变提取行为，例如"始终标注原文页码"或"不要新建顶级页面"。',
